    ...
    try:
        if isinstance(Diseases[choice], dict):
            ...
            if choice== 5:
                try:
                    if option == 1:
                        pc = colors_2 + f"Try calling 112 now and get to an Hospital asap" + colors_end_2
                    elif option == 2:
                        pc = colors_2 + f"You should apply heat and maybe try to get a nice {Meds[4]}" + colors_end_2
                    elif option == 3:
                ...
                try:
                    if option == 1:
                        ...
                        pc = colors_2 + f"Give your body a break. Drink more fluids and stop screwing up your system" + colors_end_2
                    elif option == 3:
...
if choice_feedback() == 'y' or 'n':
    get_feedback()
    if choice_reminder() == 'y' or 'n':
        set_reminder()
    else:
        sys.exit()
else:
